...
class TrainingMetricsCallback(BaseCallback):
    ...
    def _on_training_end(self):
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('reward_plot_dqn.png', dpi=150)
        plt.close()
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('length_plot_dqn.png', dpi=150)
        plt.close()
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('success_rate_plot_dqn.png', dpi=150)
        plt.close()
...
try:
    callbacks = CallbackList([
        ...
        StopAfterEpisodes(max_episodes=1_000),
    ])
